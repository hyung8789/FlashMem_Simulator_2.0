...
#define DEBUG_MODE //디버그 모드 - 발생 가능한 모든 오류 상황 추적 (주석 처리 : 사용 안함, 주석 해제 : 사용)
...
//#define VICTIM_BLOCK_DEBUG_MODE //쓰기 작업 종료 후 선정 된 Victim Block에 대해 처리를 하지 않음 (주석 처리 : 사용 안함, 주석 해제 : 사용)
